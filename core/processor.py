        ...
        for sheet_name in workbook.sheetnames:
            ...
            if sheet_name == 'PI':
                ...
                if description_row:
                    ...
                    sheet.insert_rows(description_row + 2, len(order_real_data))  # 插入行
                ...
                for cell_range in list:
                    try:
                        ...
                        if start_row >= description_row + 2 and end_row <= description_row + 2 + len(order_real_data):
                            print(f"{cell_range}")
                            sheet.unmerge_cells(str(cell_range))
                    except Exception as e:
                        print(e)

                for i, data_row in enumerate(order_real_data, start=description_row + 2):
                ...
                rich_text_a10 = CellRichText('Tel/Fax:',
                                             TextBlock(InlineFont(rFont='Times New Roman', u='single'), self.order.customer.tel_fax))
